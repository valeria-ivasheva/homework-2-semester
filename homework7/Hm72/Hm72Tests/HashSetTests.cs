...
namespace Hm72.Tests
{
    ...
    public class HashSetTests
    {
        ...
        public void CountTest()
        {
            ...
            set = new HashSet<int> { 12, 23, 90, -12, 23, 0 };
        ...
        public void CopyToTest()
        {
            ...
            Assert.AreEqual(arrayTemp[0], 1);
            Assert.AreEqual(arrayTemp[1], 2);
            Assert.AreEqual(arrayTemp[2], 3);
        }
        ...
        public void ExceptWithTest()
        {
            ...
            set = new HashSet<int> { 3, 4, 5, 56, 67, -2 };
        ...
        public void IntersectWithTest()
        {
            ...
            set = new HashSet<int> { 0, 1, 2, 3, 4, 5 };
        ...
        public void SymmetricExceptWithTest()
        {
            ...
            set.SymmetricExceptWith(arrayTemp);
            Assert.AreEqual(0, set.Count);
            set = new HashSet<int> { 123, 12, 2, 1 };
            set.SymmetricExceptWith(arrayTemp);
            Assert.AreEqual(set.Count, 3);
